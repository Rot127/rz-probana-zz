...
mod tests {
    ...
    fn get_icall_test() -> (Arc<Mutex<RzCoreWrapper>>, IntrpPath) {
        ...
        let v = VecDeque::from(vec![
            ...
            0x0800005b, 0x0800005d, 0x08000064, 0x08000067, 0x0800006a, 0x0800006d, 0x08000070,
            0x08000073, 0x08000076, 0x08000078, 0x0800007a, 0x08000081, 0x08000084, 0x08000087,
            0x0800008a, 0x0800008d, 0x08000090, 0x08000093, 0x08000095, 0x08000097, 0x0800009e,
            0x080000a1, 0x080000a4, 0x080000a7, 0x080000ab, 0x080000ac,
        ]);
