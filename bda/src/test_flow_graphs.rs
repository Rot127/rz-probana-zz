...
mod tests {
    ...
    fn get_endless_loop_icfg() -> ICFG {
        ...
        {
        cfg_a.add_edge(
            (NodeId::new(0, 0, 0xa0), CFGNodeData::new_test_single(0xa0, InsnNodeType::Entry, NodeId::new(0, 0, 0xa1), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 0xa1), CFGNodeData::new_test_single_call(0xa1, NodeId::new(0, 0, B_ADDR), false, NodeId::new(0, 0, 0xa2))),
        );
        cfg_a.add_edge(
            (NodeId::new(0, 0, 0xa1), CFGNodeData::new_test_single_call(0xa1, NodeId::new(0, 0, B_ADDR), false, NodeId::new(0, 0, 0xa2))),
            (NodeId::new(0, 0, 0xa2), CFGNodeData::new_test_single(0xa2, InsnNodeType::Return, INVALID_NODE_ID, INVALID_NODE_ID)),
        );

        cfg_b.add_edge(
            (NodeId::new(0, 0, 0xb0), CFGNodeData::new_test_single(0xb0, InsnNodeType::Entry, NodeId::new(0, 0, 0xb1), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 0xb1), CFGNodeData::new_test_single_call(0xb1, NodeId::new(0, 0, C_ADDR), false, NodeId::new(0, 0, 0xb2))),
        );
        cfg_b.add_edge(
            (NodeId::new(0, 0, 0xb1), CFGNodeData::new_test_single_call(0xb1, NodeId::new(0, 0, C_ADDR), false, NodeId::new(0, 0, 0xb2))),
            (NodeId::new(0, 0, 0xb2), CFGNodeData::new_test_single(0xb2, InsnNodeType::Return, INVALID_NODE_ID, INVALID_NODE_ID)),
        );

        cfg_c.add_edge(
            (NodeId::new(0, 0, 0xc0), CFGNodeData::new_test_single(0xc0, InsnNodeType::Entry, NodeId::new(0, 0, 0xc1), INVALID_NODE_ID)),
        ...
        cfg_c.add_edge(
            (NodeId::new(0, 0, 0xc2), CFGNodeData::new_test_single_call(0xc2, NodeId::new(0, 0, C_ADDR), false, NodeId::new(0, 0, 0xc3))),
            (NodeId::new(0, 0, 0xc3), CFGNodeData::new_test_single(0xc3, InsnNodeType::Return, INVALID_NODE_ID, INVALID_NODE_ID)),
        );
    ...
    fn get_foo_cfg() -> CFG {
        ...
        // foo()
        cfg.add_edge(
            (NodeId::new(0, 0, 6), CFGNodeData::new_test_single(6, InsnNodeType::Entry, NodeId::new(0, 0, 7), INVALID_NODE_ID)),
    ...
    fn get_cfg_no_loop_sub_routine() -> CFG {
        ...
        {
        cfg.add_edge(
            (NodeId::new(0, 0, 10), CFGNodeData::new_test_single(10, InsnNodeType::Entry, NodeId::new(0, 0, 11), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 11), CFGNodeData::new_test_single(11, InsnNodeType::Normal, NodeId::new(0, 0, 0), INVALID_NODE_ID)),
        );
        cfg.add_edge(
            (NodeId::new(0, 0, 11), CFGNodeData::new_test_single(11, InsnNodeType::Normal, NodeId::new(0, 0, 0), INVALID_NODE_ID)),
        ...
        cfg.add_edge(
            (NodeId::new(0, 0, 1), CFGNodeData::new_test_single(1, InsnNodeType::Normal, NodeId::new(0, 0, 2), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 2), CFGNodeData::new_test_single(2, InsnNodeType::Normal, NodeId::new(0, 0, 12), INVALID_NODE_ID)),
        );
        cfg.add_edge(
            (NodeId::new(0, 0, 2), CFGNodeData::new_test_single(2, InsnNodeType::Normal, NodeId::new(0, 0, 12), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 12), CFGNodeData::new_test_single(12, InsnNodeType::Normal, NodeId::new(0, 0, 13), INVALID_NODE_ID)),
    ...
    fn get_cfg_no_loop_sub_routine_loop_ret() -> CFG {
        ...
        cfg.add_edge(
            (NodeId::new(0, 0, 10), CFGNodeData::new_test_single(10, InsnNodeType::Entry, NodeId::new(0, 0, 11), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 11), CFGNodeData::new_test_single(11, InsnNodeType::Normal, NodeId::new(0, 0, 12), INVALID_NODE_ID)),
        );
        cfg.add_edge(
            (NodeId::new(0, 0, 11), CFGNodeData::new_test_single(11, InsnNodeType::Normal, NodeId::new(0, 0, 12), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 12), CFGNodeData::new_test_single(12, InsnNodeType::Normal, NodeId::new(0, 0, 13), INVALID_NODE_ID)),
        ...
        cfg.add_edge(
            (NodeId::new(0, 0, 12), CFGNodeData::new_test_single(12, InsnNodeType::Normal, NodeId::new(0, 0, 13), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 13), CFGNodeData::new_test_single(13, InsnNodeType::Normal, NodeId::new(0, 0, 14), NodeId::new(0, 0, 11))),
        );
        cfg.add_edge(
            (NodeId::new(0, 0, 13), CFGNodeData::new_test_single(13, InsnNodeType::Normal, NodeId::new(0, 0, 14), NodeId::new(0, 0, 11))),
            (NodeId::new(0, 0, 14), CFGNodeData::new_test_single(14, InsnNodeType::Return, INVALID_NODE_ID, INVALID_NODE_ID)),
        );
        cfg.add_edge(
            (NodeId::new(0, 0, 13), CFGNodeData::new_test_single(13, InsnNodeType::Normal, NodeId::new(0, 0, 14), NodeId::new(0, 0, 11))),
            (NodeId::new(0, 0, 11), CFGNodeData::new_test_single(11, InsnNodeType::Normal, NodeId::new(0, 0, 12), INVALID_NODE_ID)),
    ...
    fn get_cfg_single_node() -> CFG {
        ...
        cfg.add_node((
            NodeId::new(0, 0, 0),
            CFGNodeData::new_test_single(0, InsnNodeType::Return, INVALID_NODE_ID, INVALID_NODE_ID),
        ));
        cfg
    }
    ...
    fn get_cfg_single_self_ref() -> CFG {
        ...
        {
        cfg.add_edge(
            (NodeId::new(0, 0, 0), CFGNodeData::new_test_single(0, InsnNodeType::Return, INVALID_NODE_ID, NodeId::new(0, 0, 0))),
            (NodeId::new(0, 0, 0), CFGNodeData::new_test_single(0, InsnNodeType::Return, INVALID_NODE_ID, NodeId::new(0, 0, 0))),
        );
        }
        cfg
    ...
    fn get_cfg_simple_loop_extra_nodes() -> CFG {
        ...
        {
        cfg.add_edge(
            (NodeId::new(0, 0, 10), CFGNodeData::new_test_single(10, InsnNodeType::Entry, NodeId::new(0, 0, 0), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 0), CFGNodeData::new_test_single(0, InsnNodeType::Normal, NodeId::new(0, 0, 1), INVALID_NODE_ID)),
        );
        cfg.add_edge(
            (NodeId::new(0, 0, 0), CFGNodeData::new_test_single(0, InsnNodeType::Normal, NodeId::new(0, 0, 1), INVALID_NODE_ID)),
    ...
    fn get_cfg_self_ref_loop() -> CFG {
        ...
        cfg.add_edge(
            (NodeId::new(0, 0, 0), CFGNodeData::new_test_single(0, InsnNodeType::Entry, NodeId::new(0, 0, 1), INVALID_NODE_ID)),
            (NodeId::new(0, 0, 1), CFGNodeData::new_test_single(1, InsnNodeType::Normal, NodeId::new(0, 0, 2), NodeId::new(0, 0, 1))),
        );
        cfg.add_edge(
            (NodeId::new(0, 0, 1), CFGNodeData::new_test_single(1, InsnNodeType::Normal, NodeId::new(0, 0, 2), NodeId::new(0, 0, 1))),
            (NodeId::new(0, 0, 1), CFGNodeData::new_test_single(1, InsnNodeType::Normal, NodeId::new(0, 0, 2), NodeId::new(0, 0, 1))),
    ...
    fn test_cfg_no_return_node() {
        ...
        cfg.add_edge(
            (
                NodeId::new(0, 0, 0),
                CFGNodeData::new_test_single(0, InsnNodeType::Normal, NodeId::new(0, 0, 1), INVALID_NODE_ID),
            ),
            (
                NodeId::new(0, 0, 1),
                CFGNodeData::new_test_single(1, InsnNodeType::Normal, NodeId::new(0, 0, 2), INVALID_NODE_ID),
